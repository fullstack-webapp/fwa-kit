...
The current public prerelease is [`0.1.0-beta.1`](https://www.npmjs.com/package/@fullstack-webapp/local-edge/v/0.1.0-beta.1). The workspace demo remains the executable integration example.
